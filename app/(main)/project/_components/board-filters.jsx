...
import { X, ChartNetworkIcon } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function BoardFilters({ issues, onFilterChange, sprint }) {
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="ghost" className="flex items-center">
              <ChartNetworkIcon className="mr-2 h-4 w-4" />
            </Button>
          </DialogTrigger>
          <DialogContent className="max-w-screen max-h-screen overflow-auto">
            <Analytics sprint={sprint} issues={issues} />
          </DialogContent>
        </Dialog>
      </div>
    </div>
